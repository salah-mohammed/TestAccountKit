...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/salah-mohammed/TestAccountKit"
  ...
  s.source       = { :git => "https://github.com/salah-mohammed/TestAccountKit.git", :tag => "#{s.version}",:branch => "master"}
